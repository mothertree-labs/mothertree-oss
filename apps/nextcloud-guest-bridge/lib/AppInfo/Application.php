...
use OCA\GuestBridge\Middleware\EmailShareLinkMiddleware;
...
class Application extends App implements IBootstrap {
	...
	public function register(IRegistrationContext $context): void {
		...
		// Global: the controller it guards (/f/<fileid>) belongs to the files app,
		// not to us. It returns immediately for every other controller.
		$context->registerMiddleware(EmailShareLinkMiddleware::class, true);
	}
